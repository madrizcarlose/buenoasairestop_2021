	...
	<div class="template">
		<div class="row">
			...
			<div class="col-sm-8 col-md-8 col-lg-8" valign="center" align="center"> 
				...
				<h2 align="left">Guia - Mejores sitios</h2>
			</div>
		</div> <!--row-->
	</div> <!--template-->
</div> <!--container-->
...
<div class="carousel-inner">
    ...
    <div class="item active">
      ...
      <div class="carousel-caption">
        ...
        <p><?php print $info["direccion_negocio"];?> - <?php print $info["telef_negocio"];?>
...
<td valign="top"><b>WebPage:</b></td>
<td>
<ul class="list-group list-group-flush">
      
         
              <a href="<?php print $info['webpage']; ?>" target="_blank" ><?php print $info['webpage']; ?></a>
...
<td>
            ...
            <?php 
              $coord = $info['coord2'];
               $tira2= "<a href=".$info['url'] . " onclick=" . "\"window.open(this.href, 'mywin', 'left=200,top=20,width=900,height=500,toolbar=1,resizable=0'); return false;" . "\" align='right'>Ver mapa</a>";
              echo $tira2;
