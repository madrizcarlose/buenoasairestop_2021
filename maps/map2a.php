...
<div style="width: 200px; height: 800px; overflow-y: scroll;">
  <?php
...
for($i=0; $i<$longitud; $i++) {
  ...
  $tira2= "&nbsp;&nbsp;<a href=".$row['url'] . " onclick=" . "\"window.open(this.href, 'mywin', 'left=200,top=20,width=900,height=500,toolbar=1,resizable=0'); return false;" . "\" align='right'>Ir</a>";
   echo $tira2;
