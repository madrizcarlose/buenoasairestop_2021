...
<script>
  ...
  <body>
      ...
      <div id="content" class="p-4 p-md-5">
        ...
        <p>Conoce las mejores opciones de la cliudad de Buenos Aires. Podrás consultar la selección de los sitios mejor rankeados en la ciudad.</p>
  ...
  <div class="template">
      ...
      <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
        <!-- <a href="listsites.php?categoria=c020"><p class="h1">Bares</p> -->
         <a href="#" onclick="showList('c020');"><p class="h2">Bares</p>
      ...
      <!-- opcion Actividades-->
        ...
        <!-- <a href="listsites.php?categoria=r000"><p class="h1">Actividades</p> -->
         <a href="#" onclick="showList('r000');"><p class="h2">Actividades</p>
      ...
      <!-- opcion Actividades-->
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
        <!-- <a href="listsites.php?categoria=r000"><p class="h1">Actividades</p> -->
         <a href="#" onclick="showList('c010');"><p class="h2">Sitios turísticos</p>
      ...
      <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
       <!--   <a href="services.php"><p class="h1">Serv. y productos</p> -->
         <a href="#" onclick="openPage('services.php');"><p class="h2">Serv. y productos</p>
