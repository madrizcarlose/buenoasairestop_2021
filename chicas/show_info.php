...
<body style="font-family:sans-serif; " class="example">      
<!-- ENCABEZADO-->
	...
	<div class="template">
		<div class="row">
			...
			<div class="col-sm-8 col-md-8 col-lg-8" valign="center" align="center"> 
				...
				<font color=white><h2 align="left">Chicas Lindas</h2>
...
<img src="../images/app/utils/geo-alt.svg" alt="Bootstrap" width="32" height="32">
<font color=white size=4>Palermo&nbsp;&nbsp;
  ...
  <a href="https://api.whatsapp.com/send?phone=<?php print $info['whatsapp'];?>&text=Hola, los ubiqué en *https://topbuenosaires.online*." target="blank" >
              <img src="../images/app/utils/whatsapp_ico.png"  height="22" width="22"></a>
              <?php print $info["whatsapp"];?><br>
...
<div class="carousel-inner">
    ...
    <div class="item active">
      ...
      <div class="carousel-caption">
        ...
        <p><?php print $info["zona"];?> - <?php print $info["whatsapp"];?>
    ...
    <?php $url_pict=$fotos[$i]["url_foto"]; ?>
	  <img src='<?php print $url_pict;?>'   style="width:100%;">
        <div class="carousel-caption">
          <h3><?php print $info["nomb_negocio"];?></h3>
          <p><?php print $info["zona"];?> - <?php print $info["whatsapp"];?></p>
        </div>
      </div>
      <?php } ?>
</div>
