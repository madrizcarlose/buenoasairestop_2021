...
.header2 {margin: 15px 0 -15px 40px;}
  ...
  <body class="example">
		...
		<div class="wrapper d-flex align-items-stretch">
              ...
              <li>
                  <a href="index.php?group=categoria">Inicio</a>
	              </li>
	              <li class="active">
                    ...
                    <li>
                    <a href="index.php?categoria=diamond">Diamond &nbsp;<span class="badge rounded-pill bg-primary">3</span></a>
                    </li>
                    <li>
                    <a href="index.php?categoria=gold">Gold &nbsp;<span class="badge rounded-pill bg-primary">12</span></a>
                    </li>
                    <li>
                    <a href="index.php?categoria=silver">Silver &nbsp;<span class="badge rounded-pill bg-primary">3</span></a>
                    </li>
                    <li>
                    <a href="index.php?group=categoria">Todas &nbsp;<span class="badge rounded-pill bg-primary">3</span></a>
                    </li>
                ...
                <li class="active">
                    ...
                    <li>
                    <a href="index.php?zona=palermo">Palermo &nbsp;<span class="badge rounded-pill bg-primary">3</span></a>
                    </li>
                    <li>
                    <a href="index.php?zona=recoleta">Recoleta &nbsp;<span class="badge rounded-pill bg-primary">6</span></a>
                    </li>
                    <li>
                    <a href="index.php?zona=belgrano">Belgrano &nbsp;<span class="badge rounded-pill bg-primary">17</span></a>
                    </li>
                    <li>
                    <a href="index.php?zona=microcentro">Microcentro &nbsp;<span class="badge rounded-pill bg-primary">4</span></a>
                    </li>
                    <li>
                        <a href="index.php?group=zona">Todas</a>
	                  </li>
                   </ul>
	              </li>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="nav navbar-nav ml-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="index.php?group=categoria">Inicio</a>
                </li>
                <li class="nav-item">
  ...
  <div class="template">
    <div class="row">
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12"  >
        ...
        <p><font color=#ede8e6>Buscá por categoría o por zona.</font></p>
        <br>             
...
<a href="show_info.php?id=<?php print $row['codi_negocio'];?>" target="_blank" >
  ...
  <p class="card-text">
    ...
    <font color=#bd0909 face="arial"><?php print strtoupper($row['nomb_negocio']); ?> - <?php print $row['edad'];?></font>  </a>  
      ...
      <a href="index.php?zona=<?php print $row['zona']; ?>">
...
<div class="card text-white bg-dark mb-4" >
<a href="show_info2.php?id=<?php print $row['codi_negocio'];?>" target="_blank" >
  <img class="card-img-top" src="faces/<?php print $row['imagen_negocio']; ?>" alt="Card image cap" height="250">
 </a> 
 <div class="card text-center">
   <div class="card-body" style="background-color:#ebe9e8">
